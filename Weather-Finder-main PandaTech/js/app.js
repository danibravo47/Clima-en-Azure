...
function enviarDatosAPI(temp){
    const ciudad = document.querySelector('#ciudad').value; // Captura el valor  insertado en el campo "Ciudad"
    const pais = document.querySelector('#pais').value; // Captura el valor insertado en el campo "Pais"
    const nombre = document.querySelector('#nombre').value; // Captura el valor  insertado en el campo "Nombre"
    const cedula = document.querySelector('#cedula').value; //Captura el valor insertado en el campo "Cedula"
    console.log(`${pais}, ${ciudad}, ${nombre}, ${cedula}, ${temp}`);
    ...
    fetch("https://apipanda.azure-api.net/PandaTech/HttpPostFunctionTime", requestOptions)
